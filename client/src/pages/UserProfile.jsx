...
const UserProfile = () => {
  ...
  useEffect(()=>{
    const getUser =async () =>{
      const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/users/${currentUser.id}`, {withCredentials: true,
        headers: {
   ...
   <section className='profile'>
       <div className='container profile__container'>
           ...
           <div className='profile__details'>
            ...
            <input type='password' placeholder='New Conform Password' value={confirmNewPassword} onChange={e=>setConfirmNewPassword(e.target.value)}/>
